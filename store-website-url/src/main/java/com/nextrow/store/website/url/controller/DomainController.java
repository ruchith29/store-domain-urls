...
public class DomainController {
    ...
    public ResponseEntity<ObjectNode> createDomain(@RequestBody Map<String, String> domainData) {
    ...
    public ResponseEntity<ObjectNode> getDomainByID(@RequestBody Map<String, String> data) {
    ...
    public ResponseEntity<ObjectNode> updateDomain(@RequestBody Map<String, String> newDocument) {
        Map<String, String> response = new LinkedHashMap<>();
    ...
    public ResponseEntity<ObjectNode> deleteDomain(@RequestBody List<ObjectNode> list) {
